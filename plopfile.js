module.exports = plop => {
    ...
    plop.setGenerator('component', {
        ...
        actions: [
            ...
            {
                type: 'add',
                path: 'packages/{{name}}/typings/dongdong-components.d.ts',
                templateFile: 'templates/typings/dongdong-components.d.ts'
            },
            {
                type: 'append',
                path: 'docs/.vuepress/clientAppEnhance.ts',
                pattern: /(\/\/ -- APPSTART ITEMS HERE --)/gi,
                template: "import Oa{{hump name}} from '@dongdong-components/{{name}}'"
            },
            {
                type: 'append',
                path: 'docs/.vuepress/clientAppEnhance.ts',
                pattern: /(\/\/ -- APPEND ITEMS HERE --)/gi,
                template: "app.component('Oa{{hump name}}',Oa{{hump name}})"
            }
        ]
    })
}
